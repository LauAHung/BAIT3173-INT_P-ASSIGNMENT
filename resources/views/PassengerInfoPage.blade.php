...
<section>
  <form action="#" data-selectseat-url="{{ route('selectseat') }}">
        ...
        <div class="passenger-info-section">
            <div class="passenger-info-container">
                <div class="passenger-info-form">
                    <div class="passenger-header" onclick="togglePassenger('p1')">
                        <h2>Passenger 1</h2>
                        <button type="button" class="toggle-btn" id="toggle-p1">收起</button>
                    </div>
                    <div class="passenger-info" id="p1-info">
                        <div class="info-item">
    ...
    <div class="passenger-info-section">
        <div class="passenger-info-container">
            <div class="passenger-info-form">
                <div class="passenger-header" onclick="togglePassenger('p2')">
                    <h2>Passenger 2</h2>
                    <button type="button" class="toggle-btn" id="toggle-p2">收起</button>
                </div>
                <div class="passenger-info" id="p2-info">
                    <div class="info-item">
                        <span class="info-label">Name<a>*</a></span>
                        <input type="text" class="info-value" required>
                    </div>
                    ...
                    <div class="info-item">
                        <span class="info-label">Gender<a>*</a></span>
                        <div class="gender">
                        <label><input type="radio" name="gender2" value="male" required>Male</label>
